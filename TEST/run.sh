...
../decker --input_format "{{back_word}}[sound:{{back_sound}}]§<img src='{{front_image}}'><br><br>{{front_word}}" --input_format "<img src='{{front_image}}'><br><br>{{front_word}}§{{back_word}}[sound:{{back_sound}}]" --media_folder "SPANISH_CORE/" --dump_folder "SPANISH_CORE/" --trim --verbose "spanish_core.apkg"
read key

../decker --front_title "Core" --back_title "Núcleo" --front_language "english" --back_language "spanish" --input_format "<img src='{{front_image}}'><br><br>{{front_word}}§{{back_word}}[sound:{{back_sound}}]" --media_folder "SPANISH_CORE/" --dump_folder "SPANISH_CORE/" --trim --verbose "spanish_core.apkg" "SPANISH_CORE/spanish_core.lxf"
